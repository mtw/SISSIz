...
struct gengetopt_args_info
{
  ...
  int seed_arg;	/**< @brief Seed for the random number generator (default: from the system).  */
  char * seed_orig;	/**< @brief Seed for the random number generator (default: from the system) original value given at command line.  */
  const char *seed_help; /**< @brief Seed for the random number generator (default: from the system) help description.  */
