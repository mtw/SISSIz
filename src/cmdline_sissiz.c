...
const char *gengetopt_args_info_help[] = {
  ...
  "      --seed=INT                Seed for the random number generator (default:\n                                  from the system)",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->mono_help = gengetopt_args_info_help[11] ;
  args_info->di_help = gengetopt_args_info_help[12] ;
  args_info->dna_help = gengetopt_args_info_help[13] ;
  args_info->rna_help = gengetopt_args_info_help[14] ;
  args_info->tstv_help = gengetopt_args_info_help[15] ;
  args_info->kappa_help = gengetopt_args_info_help[16] ;
  args_info->gamma_help = gengetopt_args_info_help[17] ;
  args_info->print_tree_help = gengetopt_args_info_help[18] ;
  args_info->print_rates_help = gengetopt_args_info_help[19] ;
  args_info->clustal_help = gengetopt_args_info_help[20] ;
  args_info->maf_help = gengetopt_args_info_help[21] ;
  args_info->fasta_help = gengetopt_args_info_help[22] ;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          /* Seed for the random number generator (default: from the system).  */
          ...
          else if (strcmp (long_options[option_index].name, "clustal") == 0)
          {
